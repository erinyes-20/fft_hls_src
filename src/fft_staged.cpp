...
#pragma HLS AGGREGATE compact=auto variable=data_IN

#pragma HLS INTERFACE s_axilite port=return bundle=control
#pragma HLS INTERFACE mode=m_axi offset=slave port=data_IN bundle=M_DATA_IN
#pragma HLS INTERFACE mode=m_axi offset=slave port=data_OUT bundle=M_DATA_OUT
